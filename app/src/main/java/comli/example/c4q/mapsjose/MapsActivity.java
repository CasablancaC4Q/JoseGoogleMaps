package comli.example.c4q.mapsjose;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(nyc).title("Marker in NYC")).setIcon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_round));
